...
import Rajan from './../assets/rajan.avif'
import Footer from './../Components/Footer'

const AboutRajan = () => {
  // Tab sections with titles and content
  const sections = [
    {
  ...
  return (
    <>
      ...
      <section className="min-h-screen relative bg-black overflow-hidden">
        ...
        <div className="absolute left-0 top-1/3 w-64 h-64 bg-blue-500/30 rounded-full blur-3xl -translate-x-1/2" />
          ...
          <div className="flex-1 ">
            ...
            <div className="flex gap-4 mb-8">
              {[IoLogoInstagram, FaFacebookF, FaLinkedinIn, FaYoutube, FaXTwitter].map((Icon, i) => (
                <a key={i} className="p-3 bg-white/10 rounded-full hover:bg-white/20 transition-colors">
            ...
            <p className="text-gray-300 text-lg md:text-xl leading-relaxed max-w-2xl">
              Leading educator and community builder with over 15 years of experience in creating impactful learning ecosystems.
            </p>
          </div>
